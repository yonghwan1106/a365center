export default function FloatTel() {
  return (
    <>
      ...
      <div className="fixed bottom-6 left-6 z-[100] bg-navy text-white px-[18px] py-[10px] rounded-full text-xs font-bold shadow-[0_8px_20px_rgba(0,0,0,0.20)] flex items-center gap-2">
