...
const POSTS = [
  {
    date: "2026.05.23",
    tag: "공지",
    title: "홈페이지 v3 시안 공개 — AI 선생님 12인 교실 격상",
    desc: "‘AI 선생님이 직접 가르치는 12인 교실’을 메인 두 번째 섹션으로 격상한 사이트맵 v3가 공개되었습니다.",
  },
  {
    date: "2026.05.21",
    tag: "행정",
  ...
  },
  {
    date: "2026.05.20",
    tag: "예정",
    title: "민간자격 3종 — 2026.06.01 국가 등록 신청 예정",
    desc: "AI 디지털 교육 지도사 외 2종 자격에 대한 국가 등록 신청을 6월 1일 진행할 예정입니다.",
  },
  {
    date: "2026.05.18",
    tag: "운영",
    title: "AI 선생님 파일럿 v1 가동",
    desc: "김재완 대표가 직접 코딩한 AI 선생님 파일럿(Gemini API + STT/TTS + 60px 출력)이 가동되었습니다.",
  },
  {
    date: "2026.05.10",
    tag: "행정",
