...
export default function AITeacherPage() {
  return (
    <SiteChrome>
      <SubpageHero
        eyebrow="OST 똑똑이 선생님 파일럿 v1"
        title="50인치 화면 앞에서"
        accent="OST 똑똑이 선생님과 함께 배웁니다"
        description="마이크에 말씀하시거나 직접 입력하면 OST 똑똑이 선생님이 어르신 눈높이로 쉽게 답해드립니다. 큰 글씨, 음성 출력, 한국어 설명을 기준으로 만든 12인용 교육 파일럿입니다."
      ...
      <section id="ai-teacher-lab" className="scroll-mt-24 py-12 md:py-14">
        <div className="wrap">
          <SectionHeader
            eyebrow="체험실"
            title="OST 똑똑이 선생님에게 직접 물어보기"
            description="실제 수업에서는 강사가 질문을 정리하고, 답변을 함께 읽으며 필요한 부분을 다시 설명합니다."
          />
          <div className="mx-auto mb-7 w-[170px] md:w-[200px]">
            <Image
              src="/images/generated/ost-ddokddoki.png"
              alt="OST 똑똑이 선생님 마스코트"
              width={1254}
              height={1254}
              sizes="200px"
              className="h-auto w-full drop-shadow-[0_10px_22px_rgba(0,0,0,0.14)]"
            />
          </div>
        <AITeacherClient />
