...
export const metadata = {
  ...
  description: "수강료, 신청 방법, 교실 접근성, OST 똑똑이 선생님, 자격증, 보호자 동반 등 디지털 교육에 대한 자주 묻는 질문 모음.",
};
...
const FAQS = [
  ...
  {
    q: "한 반에 몇 명까지 수강하나요?",
    a: "12명 정원입니다. 50인치 모니터를 보면서 강사 + OST 똑똑이 선생님이 함께 가르치는 소규모 교실 구조입니다.",
  },
  {
  ...
  {
    q: "OST 똑똑이 선생님이 뭔가요?",
    a: "생성형 AI + 음성 인식(STT) + 음성 출력(TTS) + 60px 큰 글씨 출력으로 어르신 눈높이에서 답해주는 AI 보조 강사입니다. 김재완 대표가 직접 코딩한 파일럿 v1이 가동 중입니다.",
  },
  {
    q: "민간자격증을 받을 수 있나요?",
    a: "현재 민간자격 7종은 2026년 6월 1일 등록 신청 예정입니다. 등록 완료 후 정식 자격증 발급이 가능해지며, 지금은 ‘준비 중’ 상태입니다.",
  },
  {
    q: "신청 후 언제 연락이 오나요?",
  ...
  return (
    <SiteChrome>
      <SubpageHero
        ...
        description="수강료, 신청 방법, 교실 접근성, OST 똑똑이 선생님, 자격증, 보호자 동반 등 디지털 교육에 관한 모든 질문에 답변드립니다."
