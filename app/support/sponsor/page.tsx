...
const PARTNERSHIPS = [
  ...
  { icon: "💼", title: "CSR·ESG 지정후원", desc: "디지털 교육, OST 똑똑이 선생님 운영, 푸드뱅크 등 사업별 지정후원 가능. 결산 보고서 제공." },
  ...
  { icon: "🎓", title: "자격 과정 협력", desc: "민간자격 7종 등록 후 산업체·기관 연계 자격 취득 과정 공동 운영." },
];
      ...
      <section className="bg-bg-soft py-12 md:py-14">
        <div className="wrap">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            ...
            <InfoCard icon="🤖" title="차별화된 운영 실체">OST 똑똑이 선생님 12인 교실은 전국 어디에도 없는 고유 자산. 공모·취재에서 즉시 차별화.</InfoCard>
